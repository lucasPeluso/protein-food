        ...
        <footer className="footer">
            <div className="footer__flex">
                ...
                <div className='footer__flex-contact-join'>
                    <h4 className="text-start color-gray underline">{t("footer.contactus")}</h4>
                ...
                <nav className='footer__flex-links'>
                    ...
                    <NavLink to="markets">{t("footer.markets")}</NavLink>
                    <NavLink to="values">{t("footer.values")}</NavLink>
                    <NavLink to="contact">{t("footer.contact")}</NavLink>
                </nav>
            </div>

            <div className='footer__author'>
                <p className="footer__author-p color-gray">2023 Copyright © All right reserved.</p>
                <p className="footer__author-p color-gray">Made by <a className='color-gray' href="https://www.linkedin.com/in/lucas-peluso" target="_blank" rel="noopener">Lucas Peluso.</a></p>
            </div>
        </footer>
    )
}
